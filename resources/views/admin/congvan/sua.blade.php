                ...
                <div class="col-lg-7" style="padding-bottom:120px">
                    ...
                    <div id="phongbanSelect" class="form-group" style="display: none;">
                        ...
                        <select class="form-control" name="PhongBan">
                            ...
                            @foreach($dsphongban as $phongban)
                                <option @if($lhcv->id == $phongban->idloaihinhcongvan) selected @endif value="{{ $phongban->id }}">{{ $phongban->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        @if($congvan->tentaptindinhkem != '')
                            <a href="{{ asset('storage/'. $congvan->tentaptindinhkem) }}" target="_blank">Bấm vào đây để xem</a>
                        @endif
                    </div>
