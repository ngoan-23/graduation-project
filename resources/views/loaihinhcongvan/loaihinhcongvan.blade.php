...
<div class="col-md-9">
	...
	<div class="panel-heading" style="background-color:#337AB7; color:white;" >
	            		<h2 style="margin-top:0px; margin-bottom:0px;">Loại hình công văn: {{ $loaihinhcongvan->name }}</h2>
	            	</div>
			...
			@foreach($congvan as $cv)
				@if(Auth::user())
					<tr class="odd gradeX" align="center">
						...
						<td>{{ $cv->nguoiky}}</td>
						<td><a href="/download/{{ $cv->id }}"><div  class="glyphicon glyphicon-download-alt"></div></a></td>
						<?php $i++;?>
					</tr>
				@else
					<tr class="odd gradeX" align="center">
